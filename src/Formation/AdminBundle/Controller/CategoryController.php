...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('FormationAdminBundle:category:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('FormationAdminBundle:category:new.html.twig', array(
            'category' => $category,
    ...
    public function showAction(Category $category)
    {
        ...
        return $this->render('FormationAdminBundle:category:show.html.twig', array(
            'category' => $category,
    ...
    {
        $deleteForm = $this->createDeleteForm($category);
        $editForm = $this->createForm('Formation\AdminBundle\Form\CategoryType', $category);
        ...
        return $this->render('FormationAdminBundle:category:edit.html.twig', array(
            'category' => $category,
